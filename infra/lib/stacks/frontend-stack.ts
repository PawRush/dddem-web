...
export class FrontendStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: FrontendStackProps) {
    ...
    const cloudfrontToS3 = new CloudFrontToS3(this, "CFToS3", {
      ...
      // Disabled - using managed SECURITY_HEADERS policy + CSP function
    ...
    // URL rewrite function for /path to /path/index.html (Next.js trailingSlash: true)
    ...
    // Add URL rewrite function to the default behavior
