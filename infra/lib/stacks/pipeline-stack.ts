  ...
  constructor(scope: Construct, id: string, props: PipelineStackProps) {
    ...
    const synth = new pipelines.ShellStep("Synth", {
      ...
      commands: [
        ...
        // Unit tests only (lint skipped due to ESLint config issues)
        "npm run test",
    ...
    new FrontendStack(deployStage, "DDDEMWebFrontend-prod", {
      stackName: "DDDEMWebFrontend-prod",
      environment: "prod",
      buildOutputPath: "../out",
    });
