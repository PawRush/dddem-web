  ...
  constructor(scope: Construct, id: string, props: PipelineStackProps) {
    ...
    const synth = new pipelines.ShellStep("Synth", {
      ...
      commands: [
        ...
        // Unit tests only (lint excluded due to ESLint v9 migration)
        "npm run test",

        // Secret scanning
        "npx -y @secretlint/quick-scanner '**/*'",
    ...
    new FrontendStack(deployStage, "dddemFrontend-prod", {
      stackName: "dddemFrontend-prod",
      environment: "prod",
      buildOutputPath: "../out",
    });
